...
<body>
    ...
    <section class="pt-100px pb-100px h-400px"
        ...
        <div class="container h-100">
            <div class="row align-items-end h-100 md-mt-50px">
                <div class="col-xl-6 col-lg-6 position-relative z-index-1"
                    ...
                    <h1 class="alt-font fs-70 text-white fw-500 ls-minus-2px">About
                        </span>
                    </h1>
                </div>
            </div>
    ...
    <body>
        ...
        <div class="about-section">
            ...
            <div class="about-text">
                <h2>About Tambaram</h2>
                <p>Tambaram Town is situated 24 K.M. south of the capital city of Chennai. The famous Grand Southern
                    Trunk Road and Railway Route from Chennai Egmore to Kanyakumari divide the town into East and West.
                    The municipal town, Tambaram, is described as the gateway of the beautiful metropolitan city,
                    Chennai.</p>
            </div>

            <!-- Right side images -->
            <div class="about-images">
                <img src="assets/images/about/4.png" alt="Decorative Background" class="decorative-background">
                <img src="assets/images/about/1.png" alt="Tambaram Wall Art" class="main-image">
                <img src="assets/images/about/2.png" alt="Tambaram Area" class="overlay-image">
            </div>
        </div>

        <div class="overlay-section">
            <div class="overlay-content">
                Tambaram is very popular because of the existence of world-renowned Madras Christian College, IAF
                Training Center, and the first commissioned suburban trains from Tambaram to the beach. Nowadays, almost
                all trains to southern parts of Tamil Nadu start only from Tambaram. This municipal town is also proud
                of being home to a number of industrial units established at the Madras Export Processing Zone (MEPZ).
                The units in the MEPZ export various items to several foreign countries, thereby earning foreign
                exchange for the country.
                <br><br>
                Tambaram is one of the busiest towns in and around Chennai with extensive transport facilities. Tambaram
                Town is also well known for its reputed educational institutions. Prior to 1964, Tambaram was a small
                panchayat. In 1964 it was constituted as Grade III Municipality comprising the village panchayats of
                Pulikuradu, Irumbuliyur, Selaiyur. Due to rapid development and growth of the town commercially and
                residentially, the municipality is now classified as a special grade municipality. The population as per
                2011 census is 1,64,830 besides a floating population of more than 1 lakh per day. The extent of the
                municipality is 20.72 sq. km.
            </div>
        </div>
            ...
            <div class="container">
                <div class="row d-flex footer-content" style="height: 100%;">
                    <div
                        ...
                        <img src="assets/images/footer-logo.png" alt="" class="mb-10px footer-logo"
                            style="width: 340px" />
                        ...
                        <div class="footer-social-icons">
                            <a href="#" target="_blank" class="pe-10px"><svg xmlns="http://www.w3.org/2000/svg"
